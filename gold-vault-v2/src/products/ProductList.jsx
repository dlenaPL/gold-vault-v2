...
import "../goldCoinsPage/GoldCoinsPage.css"
import ProductPagginationList from '../goldCoinsPage/ProductPagginationList'
      ...
      <div className='gold-page-content'>
        <div className='title'>
          ...
          <div className='title-paragraph'>
            <span>
              Złote i srebrne monety bulionowe to doskonała inwestycja dla osób poszukujących długoterminowego 
